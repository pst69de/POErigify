...
class Rig:
    ...
    def __init__(self, obj, bone_name, params):
        ...
        self.obj = obj
        print('!!!WIP!!! cat_crotch_female on %s' % bone_name)
    ...
    def make_mechanics(self):
        ...
        print('cat_crotch_female.make_mechanics -> no mechanis')
    ...
    def make_controls(self):
        ...
        # Just a control for ...
        print('cat_crotch_female.make_controls -> no controls')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        ctrls = []
    ...
    def make_tweaks(self):
        ...
        print('cat_crotch_female.make_tweaks -> no tweaks')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        tweaks = []
    ...
    def make_deform(self):
        ...
        print('cat_crotch_female.make_deform -> no deform')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        deforms = []
    ...
    def make_constraints(self, all_bones):
        ...
        print('cat_crotch_female.make_constraints -> no constraints')
    ...
    def parent_bones(self, all_bones):
        ...
        print('cat_crotch_female.parent_bones -> no parenting')
        # test if above works out
        #return
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
    ...
    def generate(self):
        ...
        print('cat_crotch_female.generate')
        bpy.ops.object.mode_set(mode ='EDIT')
        eb = self.obj.data.edit_bones
...
def create_sample(obj):
    ...
    bone.head[:] = -0.0000, 0.0303, 0.9933
    bone.tail[:] = 0.0000, -0.0020, 0.9060
    bone.roll = -3.1416
    bone.use_connect = False
    bones['base_crotch'] = bone.name
    bone = arm.edit_bones.new('base_ass')
    bone.head[:] = 0.0000, -0.0020, 0.9060
    bone.tail[:] = 0.0000, 0.0613, 0.8908
    bone.roll = 0.0000
    ...
    bone.head[:] = 0.0000, -0.0020, 0.9060
    bone.tail[:] = 0.0000, -0.0228, 0.8629
    bone.roll = -3.1416
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_crotch']]
    bones['base_genital'] = bone.name
    bone = arm.edit_bones.new('ass_sizer')
    bone.head[:] = 0.0000, 0.0613, 0.8908
    bone.tail[:] = 0.0000, 0.0647, 0.8870
    bone.roll = -1.5708
    bone.use_connect = True
    ...
    bone.head[:] = 0.0000, 0.0613, 0.8908
    bone.tail[:] = 0.0000, 0.0586, 0.8883
    bone.roll = -1.5708
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_ass']]
    bones['ass_radial'] = bone.name
    bone = arm.edit_bones.new('base_genitalback')
    bone.head[:] = 0.0000, -0.0228, 0.8629
    bone.tail[:] = 0.0000, 0.0217, 0.8563
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head[:] = 0.0000, -0.0228, 0.8629
    bone.tail[:] = 0.0000, -0.0612, 0.8790
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_genital']]
    bones['base_genitalfront'] = bone.name
    bone = arm.edit_bones.new('labia.L')
    bone.head[:] = -0.0000, 0.0217, 0.8563
    bone.tail[:] = 0.0052, 0.0148, 0.8544
    bone.roll = 2.5430
    bone.use_connect = True
    ...
    bone.head[:] = 0.0000, -0.0612, 0.8790
    bone.tail[:] = 0.0000, -0.0658, 0.8849
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_genitalfront']]
    bones['ctl_genitalshaft'] = bone.name
    bone = arm.edit_bones.new('labia.001.L')
    bone.head[:] = 0.0052, 0.0148, 0.8544
    bone.tail[:] = 0.0058, 0.0017, 0.8522
    bone.roll = 4.2239
    bone.use_connect = True
    ...
    bone.head[:] = 0.0000, -0.0658, 0.8849
    bone.tail[:] = 0.0000, -0.0612, 0.8790
    bone.roll = 3.1416
    bone.use_connect = True
    ...
    bone.head[:] = 0.0058, 0.0017, 0.8522
    bone.tail[:] = 0.0064, -0.0173, 0.8538
    bone.roll = 5.3093
    bone.use_connect = True
