...
class Rig:
    ...
    def __init__(self, obj, bone_name, params):
        ...
        self.obj = obj
        print('!!!WIP!!! cat_crotch_futa on %s' % bone_name)
    ...
    def make_mechanics(self):
        ...
        print('cat_crotch_futa.make_mechanics -> no mechanis')
    ...
    def make_controls(self):
        ...
        # Just a control for ...
        print('cat_crotch_futa.make_controls -> no controls')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        ctrls = []
    ...
    def make_tweaks(self):
        ...
        print('cat_crotch_futa.make_tweaks -> no tweaks')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        tweaks = []
    ...
    def make_deform(self):
        ...
        print('cat_crotch_futa.make_deform -> no deform')
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
        eb = self.obj.data.edit_bones
        deforms = []
    ...
    def make_constraints(self, all_bones):
        ...
        print('cat_crotch_futa.make_constraints -> no constraints')
    ...
    def parent_bones(self, all_bones):
        ...
        print('cat_crotch_futa.parent_bones -> no parenting')
        # test if above works out
        #return
        bpy.ops.object.mode_set(mode ='EDIT')
        org_bones = self.org_bones
    ...
    def generate(self):
        ...
        print('cat_crotch_futa.generate')
        bpy.ops.object.mode_set(mode ='EDIT')
        eb = self.obj.data.edit_bones
...
def create_sample(obj):
    ...
    bone.head[:] = 0.0000, -0.0065, 1.0142
    bone.tail[:] = -0.0000, -0.0373, 0.8723
    bone.roll = -3.1416
    bone.use_connect = False
    bones['base_crotch'] = bone.name
    bone = arm.edit_bones.new('base_ass')
    bone.head[:] = -0.0000, -0.0373, 0.8723
    bone.tail[:] = -0.0000, 0.0270, 0.8517
    bone.roll = 0.0000
    ...
    bone.head[:] = -0.0000, -0.0373, 0.8723
    bone.tail[:] = -0.0000, -0.1305, 0.8537
    bone.roll = -3.1416
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_crotch']]
    bones['base_genital'] = bone.name
    bone = arm.edit_bones.new('ass_sizer')
    bone.head[:] = -0.0000, 0.0270, 0.8517
    bone.tail[:] = -0.0000, 0.0309, 0.8483
    bone.roll = -1.5708
    bone.use_connect = True
    ...
    bone.head[:] = -0.0000, 0.0270, 0.8517
    bone.tail[:] = -0.0000, 0.0239, 0.8478
    bone.roll = -1.5708
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_ass']]
    bones['ass_radial'] = bone.name
    bone = arm.edit_bones.new('base_genitalback')
    bone.head[:] = -0.0000, -0.1305, 0.8537
    bone.tail[:] = 0.0000, -0.0097, 0.8133
    bone.roll = -0.0000
    bone.use_connect = True
    ...
    bone.head[:] = -0.0000, -0.1305, 0.8537
    bone.tail[:] = -0.0000, -0.1173, 0.8059
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_genital']]
    bones['base_genitalfront'] = bone.name
    bone = arm.edit_bones.new('labia.L')
    bone.head[:] = -0.0000, -0.0097, 0.8133
    bone.tail[:] = 0.0038, -0.0144, 0.8098
    bone.roll = 3.2441
    bone.use_connect = True
    ...
    bone.head[:] = -0.0000, -0.1173, 0.8059
    bone.tail[:] = -0.0000, -0.0855, 0.8057
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['base_genitalfront']]
    bones['ctl_genitalshaft'] = bone.name
    bone = arm.edit_bones.new('labia.001.L')
    bone.head[:] = 0.0038, -0.0144, 0.8098
    bone.tail[:] = 0.0045, -0.0353, 0.8098
    bone.roll = 1.6086
    bone.use_connect = True
    ...
    bone.head[:] = -0.0000, -0.0855, 0.8057
    bone.tail[:] = -0.0000, -0.1173, 0.8059
    bone.roll = 3.1416
    bone.use_connect = True
    ...
    bone.head[:] = 0.0045, -0.0353, 0.8098
    bone.tail[:] = 0.0051, -0.0606, 0.8090
    bone.roll = 3.2665
    bone.use_connect = True
