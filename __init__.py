...
bl_info = {
    "name": "POErigify",
    "version": (0, 5),
    "author": "Patrick O.Ehrmann, Nathan Vegdahl, Lucio Rossi, Ivan Cappiello",
    "blender": (2, 79, 0),
    "description": "Fork by Patrick O. Ehrmann (pst69de) Do not use along with Rigify activated",
...
def register():
    ...
    if (ui and 'legacy' in str(ui)) or bpy.context.user_preferences.addons['POErigify'].preferences.legacy_mode:
        # update legacy on restart or reload
        bpy.context.user_preferences.addons['POErigify'].preferences.legacy_mode = True
